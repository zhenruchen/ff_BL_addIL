...
def IL2_p2i_conn(source, target, prob=0.1, min_dist=0.0, max_dist=300.0, min_syns=1, max_syns=2):
    sid = source.node_id
    tid = target.node_id
    Pid=sid-numBL
...
def IL2_i2p_conn(source, target, prob=0.1, min_dist=0.0, max_dist=300.0, min_syns=1, max_syns=2):
    sid = source.node_id
    tid = target.node_id
    Pid=sid-numBL
    Iid=tid-numBL-numIL13_Pyr
...
def IL2_p2i_conn(source, target, prob=0.1, min_dist=0.0,max_dist=300.0, min_syns=1,
    ...
    sid = source.node_id
    tid = target.node_id
    Pid=sid-numBL-numIL23
    Iid=tid-numBL-numIL23-numIL56_Pyr
