...
#define nrn_init _nrn_init__catp
#define _nrn_initial _nrn_initial__catp
#define nrn_cur _nrn_cur__catp
#define _nrn_current _nrn_current__catp
#define nrn_jacob _nrn_jacob__catp
#define nrn_state _nrn_state__catp
#define _net_receive _net_receive__catp 
#define rates rates__catp 
#define states states__catp 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "ghk_catp", _hoc_ghk,
 "h2_catp", _hoc_h2,
 "rates_catp", _hoc_rates,
 "states_catp", _hoc_states,
 0, 0
};
#define KTF KTF_catp
#define _f_betm _f_betm_catp
#define _f_alpm _f_alpm_catp
#define _f_beth _f_beth_catp
#define _f_alph _f_alph_catp
#define alpm alpm_catp
#define alph alph_catp
#define betm betm_catp
#define beth beth_catp
#define efun efun_catp
#define ghk ghk_catp
#define h2 h2_catp
...
#define tfa tfa_catp
 double tfa = 1;
#define tBase tBase_catp
 double tBase = 23.5;
#define usetable usetable_catp
 double usetable = 1;
 ...
 "tBase_catp", &tBase_catp,
 "ki_catp", &ki_catp,
 "tfa_catp", &tfa_catp,
 "tfi_catp", &tfi_catp,
 "eca_catp", &eca_catp,
 "usetable_catp", &usetable_catp,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "Ca_ion");
 	...
 	ivoc_help("help ?1 catp /home/mizzou/Desktop/SS-cortex/x86_64/catp.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("catp", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ...
  cao = _ion_cao;
 { error =  states();
 if(error){fprintf(stderr,"at line 60 in file catp.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/Desktop/SS-cortex/catp.mod";
static const char* nmodl_file_text = 
