...
#define _f_mh _f_mh__na 
#define iassign iassign__na 
#define mh mh__na 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "beta_na", _hoc_beta,
 "ghkca_na", _hoc_ghkca,
 "iassign_na", _hoc_iassign,
 "mh_na", _hoc_mh,
 "states_na", _hoc_states,
 0, 0
};
#define FRT FRT_na
#define alpha alpha_na
#define beta beta_na
#define ghkca ghkca_na
...
#define hq10 hq10_na
 double hq10 = 3;
#define htemp htemp_na
 double htemp = 37;
#define hbasetau hbasetau_na
 double hbasetau = 0.5;
#define hvhalf hvhalf_na
 double hvhalf = -42;
#define hbaserate hbaserate_na
 double hbaserate = 0.2;
#define hgamma hgamma_na
 double hgamma = 0.5;
#define hvalence hvalence_na
 double hvalence = -6;
#define mexp mexp_na
 double mexp = 3;
#define mq10 mq10_na
 double mq10 = 3;
#define mtemp mtemp_na
 double mtemp = 37;
#define mbasetau mbasetau_na
 double mbasetau = 0.05;
#define mvhalf mvhalf_na
 double mvhalf = -38;
#define mgamma mgamma_na
 double mgamma = 0.7;
#define mvalence mvalence_na
 double mvalence = 4.3;
...
#define vmax vmax_na
 ...
 "erev_na", &erev_na,
 "mvalence_na", &mvalence_na,
 "mgamma_na", &mgamma_na,
 "mvhalf_na", &mvhalf_na,
 "mbasetau_na", &mbasetau_na,
 "mtemp_na", &mtemp_na,
 "mq10_na", &mq10_na,
 "mexp_na", &mexp_na,
 "hvalence_na", &hvalence_na,
 "hgamma_na", &hgamma_na,
 "hbaserate_na", &hbaserate_na,
 "hvhalf_na", &hvhalf_na,
 "hbasetau_na", &hbasetau_na,
 "htemp_na", &htemp_na,
 "hq10_na", &hq10_na,
 "hexp_na", &hexp_na,
 "vmax_na", &vmax_na,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 7, "ca_ion");
 	...
 	ivoc_help("help ?1 na /home/mizzou/Desktop/SS-cortex/x86_64/na.mod\n");
 ...
 v=_v;
{
  ...
  cai = _ion_cai;
 { error =  states();
 if(error){fprintf(stderr,"at line 166 in file na.mod:\n\n"); nrn_complain(_p); abort_run(error);}
 }   }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/Desktop/SS-cortex/na.mod";
static const char* nmodl_file_text = 
