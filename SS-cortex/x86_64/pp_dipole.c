...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "pointer");
 	...
 	ivoc_help("help ?1 Dipole /home/mizzou/Desktop/SS-cortex/x86_64/pp_dipole.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/Desktop/SS-cortex/pp_dipole.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  ": SUFFIX dipole\n"
