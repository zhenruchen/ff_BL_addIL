...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 h /home/mizzou/Desktop/SS-cortex/x86_64/h.mod\n");
...
static int h (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset=0; int error = 0;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/Desktop/SS-cortex/h.mod";
static const char* nmodl_file_text = 
