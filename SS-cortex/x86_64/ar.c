...
#define _f_settables _f_settables__ar 
#define settables settables__ar 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 ar /home/mizzou/Desktop/SS-cortex/x86_64/ar.mod\n");
...
static int  _f_settables ( _threadargsprotocomma_ double _lv ) {
   minf = 1.0 / ( 1.0 + exp ( ( _lv + 75.0 ) / 5.5 ) ) ;
   mtau = 1.0 / ( exp ( - 14.6 - 0.086 * _lv ) + exp ( - 1.87 + 0.07 * _lv ) ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/Desktop/SS-cortex/ar.mod";
static const char* nmodl_file_text = 
