...
src_ids = np.array(edges_info['edges']['SPWR_biophysical_to_SPWR_biophysical']['source_node_id'])
tgt_ids = np.array(edges_info['edges']['SPWR_biophysical_to_SPWR_biophysical']['target_node_id'])
