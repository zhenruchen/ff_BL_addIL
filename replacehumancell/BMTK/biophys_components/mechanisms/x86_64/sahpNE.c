...
#define nrn_init _nrn_init__sAHPNE
#define _nrn_initial _nrn_initial__sAHPNE
#define nrn_cur _nrn_cur__sAHPNE
#define _nrn_current _nrn_current__sAHPNE
#define nrn_jacob _nrn_jacob__sAHPNE
#define nrn_state _nrn_state__sAHPNE
#define _net_receive _net_receive__sAHPNE 
#define rate rate__sAHPNE 
#define states states__sAHPNE 
