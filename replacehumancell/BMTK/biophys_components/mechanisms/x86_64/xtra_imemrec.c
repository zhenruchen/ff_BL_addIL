...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_xtraimemrec", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define LFP LFP_xtraimemrec
 double LFP = 0;
#define is is_xtraimemrec
 double is = 0;
 ...
 "is_xtraimemrec", "milliamp",
 "LFP_xtraimemrec", "millivolts",
 "rx_xtraimemrec", "megohm",
 "x_xtraimemrec", "1",
 "y_xtraimemrec", "1",
 "z_xtraimemrec", "1",
 "er_xtraimemrec", "microvolts",
 "LFPtemp_xtraimemrec", "millivolts",
 "im_xtraimemrec", "milliamp/cm2",
 "ex_xtraimemrec", "millivolts",
 0,0
};
 static double v = 0;
 /* connect global user variables to hoc */
 static DoubScal hoc_scdoub[] = {
 "is_xtraimemrec", &is_xtraimemrec,
 "LFP_xtraimemrec", &LFP_xtraimemrec,
 0,0
};
