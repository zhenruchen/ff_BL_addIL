...
#define nrn_init _nrn_init__interD2interD_STFD
#define _nrn_initial _nrn_initial__interD2interD_STFD
#define nrn_cur _nrn_cur__interD2interD_STFD
#define _nrn_current _nrn_current__interD2interD_STFD
#define nrn_jacob _nrn_jacob__interD2interD_STFD
#define nrn_state _nrn_state__interD2interD_STFD
#define _net_receive _net_receive__interD2interD_STFD 
#define release release__interD2interD_STFD 
...
#define r_nmda _p[47]
#define r_gaba _p[48]
#define capoolcon _p[49]
#define W _p[50]
#define eca _p[51]
#define ica _p[52]
#define t0 _p[53]
#define ICan _p[54]
#define Afactor _p[55]
#define dW_gaba _p[56]
#define rp _p[57]
#define tsyn _p[58]
#define fa _p[59]
#define Dr_nmda _p[60]
#define Dr_gaba _p[61]
#define Dcapoolcon _p[62]
#define DW _p[63]
#define _g _p[64]
#define _tsav _p[65]
...
#define DA2 DA2_interD2interD_STFD
#define DA1 DA1_interD2interD_STFD
#define GAP1 GAP1_interD2interD_STFD
#define NE2 NE2_interD2interD_STFD
#define NEn NEn_interD2interD_STFD
#define eta eta_interD2interD_STFD
#define omega omega_interD2interD_STFD
#define unirand unirand_interD2interD_STFD
...
#define Beta2 Beta2_interD2interD_STFD
 double Beta2 = 0.0001;
#define Beta1 Beta1_interD2interD_STFD
 double Beta1 = 0.001;
#define DA_S DA_S_interD2interD_STFD
 double DA_S = 1.6;
#define DA_t3 DA_t3_interD2interD_STFD
 double DA_t3 = 1.25;
#define DA_t2 DA_t2_interD2interD_STFD
 double DA_t2 = 1.5;
#define DA_t1 DA_t1_interD2interD_STFD
 double DA_t1 = 0.7;
#define DAstop2 DAstop2_interD2interD_STFD
 double DAstop2 = 36000;
#define DAstart2 DAstart2_interD2interD_STFD
 double DAstart2 = 35900;
#define DAstop1 DAstop1_interD2interD_STFD
 double DAstop1 = 40000;
#define DAstart1 DAstart1_interD2interD_STFD
 double DAstart1 = 39500;
#define GAPstop1 GAPstop1_interD2interD_STFD
 double GAPstop1 = 196000;
#define GAPstart1 GAPstart1_interD2interD_STFD
 double GAPstart1 = 96000;
#define NE_S NE_S_interD2interD_STFD
 double NE_S = 1;
#define NE_t3 NE_t3_interD2interD_STFD
 double NE_t3 = 1;
#define NE_t2 NE_t2_interD2interD_STFD
 double NE_t2 = 1;
#define NE_t1 NE_t1_interD2interD_STFD
 double NE_t1 = 1;
#define NEstop2 NEstop2_interD2interD_STFD
 double NEstop2 = 36000;
#define NEstart2 NEstart2_interD2interD_STFD
 double NEstart2 = 35900;
#define NEstop1 NEstop1_interD2interD_STFD
 double NEstop1 = 40000;
#define NEstart1 NEstart1_interD2interD_STFD
 double NEstart1 = 39500;
#define k k_interD2interD_STFD
 double k = 0.01;
 ...
 "Beta1_interD2interD_STFD", "/ms",
 "Beta2_interD2interD_STFD", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_gaba", "ms",
 "AlphaTmax_gaba", "/ms",
 ...
 "k_interD2interD_STFD", &k_interD2interD_STFD,
 "GAPstart1_interD2interD_STFD", &GAPstart1_interD2interD_STFD,
 "GAPstop1_interD2interD_STFD", &GAPstop1_interD2interD_STFD,
 "DAstart1_interD2interD_STFD", &DAstart1_interD2interD_STFD,
 "DAstop1_interD2interD_STFD", &DAstop1_interD2interD_STFD,
 "DAstart2_interD2interD_STFD", &DAstart2_interD2interD_STFD,
 "DAstop2_interD2interD_STFD", &DAstop2_interD2interD_STFD,
 "DA_t1_interD2interD_STFD", &DA_t1_interD2interD_STFD,
 "DA_t2_interD2interD_STFD", &DA_t2_interD2interD_STFD,
 "DA_t3_interD2interD_STFD", &DA_t3_interD2interD_STFD,
 "DA_S_interD2interD_STFD", &DA_S_interD2interD_STFD,
 "Beta1_interD2interD_STFD", &Beta1_interD2interD_STFD,
 "Beta2_interD2interD_STFD", &Beta2_interD2interD_STFD,
 "NEstart1_interD2interD_STFD", &NEstart1_interD2interD_STFD,
 "NEstop1_interD2interD_STFD", &NEstop1_interD2interD_STFD,
 "NEstart2_interD2interD_STFD", &NEstart2_interD2interD_STFD,
 "NEstop2_interD2interD_STFD", &NEstop2_interD2interD_STFD,
 "NE_t1_interD2interD_STFD", &NE_t1_interD2interD_STFD,
 "NE_t2_interD2interD_STFD", &NE_t2_interD2interD_STFD,
 "NE_t3_interD2interD_STFD", &NE_t3_interD2interD_STFD,
 "NE_S_interD2interD_STFD", &NE_S_interD2interD_STFD,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _interD2interD_STFD_new_reg() {
	int _vectorized = 0;
  _initlists();
 	ion_reg("ca", -10000.);
...
#endif
  hoc_register_prop_size(_mechtype, 66, 6);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 interD2interD_STFD /home/mizzou/Desktop/ff_BL_addIL/replacehumancell/BMTK/biophys_components/mechanisms/x86_64/interD2interD_STFD_new.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 183 in file interD2interD_STFD_new.mod:\n	 \n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/Desktop/ff_BL_addIL/replacehumancell/BMTK/biophys_components/mechanisms/modfiles/interD2interD_STFD_new.mod";
static const char* nmodl_file_text = 
  ":Interneuron Cells to Pyramidal Cells GABA with local Ca2+ pool and read public soma Ca2+ pool\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS interD2interD_STFD\n"
  ...
  "	RANGE fmax, fmin, Wmax, Wmin, maxChange, normW, scaleW, srcid, destid,limitW,irecord\n"
  ...
  "	\n"
  "	Cdur_gaba = 0.7254 (ms)\n"
  "	AlphaTmax_gaba = 1.853 (/ms):7.2609 (/ms): 2.2609 (/ms): 3.2609 (/ms)   : 7.2609 as original\n"
  "	Beta_gaba = 0.147(/ms) : 0.147 (/ms) : 0.2667 (/ms):         : 0.2667 as original\n"
  "	Erev_gaba = -75 (mV) : -75 as original\n"
  "	gbar_gaba = 0.2e-3 (uS) : 0.6e-3 (uS)\n"
  "\n"
  "	Cainf = 50e-6 (mM)\n"
  ...
  "\n"
  "	:GABA Weight\n"
  "	initW = 2.0 : 5.0 : 3.0 : 4.0 : 5.0 : 4.2 : 3.5 :4.5 : :  :  3 :  2.5 : 5\n"
  "	fmax = 3 : 2.85 :4 : 3 : 3\n"
  "	fmin = .8\n"
  "	\n"
  "	GAPstart1 = 96000 \n"
