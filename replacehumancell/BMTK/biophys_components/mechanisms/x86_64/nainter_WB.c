...
#define nrn_init _nrn_init__nainter_WB
#define _nrn_initial _nrn_initial__nainter_WB
#define nrn_cur _nrn_cur__nainter_WB
#define _nrn_current _nrn_current__nainter_WB
#define nrn_jacob _nrn_jacob__nainter_WB
#define nrn_state _nrn_state__nainter_WB
#define _net_receive _net_receive__nainter_WB 
#define rate rate__nainter_WB 
#define states states__nainter_WB 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_nainter_WB", _hoc_setdata,
 "hbet_nainter_WB", _hoc_hbet,
 "half_nainter_WB", _hoc_half,
 "mbet_nainter_WB", _hoc_mbet,
 "malf_nainter_WB", _hoc_malf,
 "rate_nainter_WB", _hoc_rate,
 0, 0
};
#define hbet hbet_nainter_WB
#define half half_nainter_WB
#define mbet mbet_nainter_WB
#define malf malf_nainter_WB
 ...
 "gnabar_nainter_WB", 0, 1e+09,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gnabar_nainter_WB", "mho/cm2",
 "ina_nainter_WB", "mA/cm2",
 "mtau_nainter_WB", "ms",
 "htau_nainter_WB", "ms",
 0,0
};
...
double malf ( _threadargsprotocomma_ double _lv ) {
   double _lmalf;
 _lmalf = - 1000.0 * 0.1 * ( _lv + 35.0 ) / ( exp ( - 0.1 * ( _lv + 35.0 ) ) - 1.0 ) ;
...
double mbet ( _threadargsprotocomma_ double _lv ) {
   double _lmbet;
 _lmbet = 1000.0 * 4.0 * exp ( - ( _lv + 60.0 ) / 18.0 ) ;
...
double half ( _threadargsprotocomma_ double _lv ) {
   double _lhalf;
 _lhalf = 5.0 * 0.07 * exp ( - ( _lv + 58.0 ) / 20.0 ) ;
...
double hbet ( _threadargsprotocomma_ double _lv ) {
   double _lhbet;
 _lhbet = 5.0 * 1.0 / ( exp ( - 0.1 * ( _lv + 28.0 ) ) + 1.0 ) ;
