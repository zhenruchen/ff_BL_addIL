...
#define inmda _p[35]
#define g_nmda _p[36]
#define on_nmda _p[37]
#define W_nmda _p[38]
#define iampa _p[39]
#define g_ampa _p[40]
#define on_ampa _p[41]
#define limitW _p[42]
#define ICa _p[43]
...
#define tempW _p[50]
#define pregid _p[51]
#define postgid _p[52]
#define F _p[53]
#define D1 _p[54]
#define D2 _p[55]
#define r_nmda _p[56]
#define r_ampa _p[57]
#define capoolcon _p[58]
#define W _p[59]
#define eca _p[60]
#define t0 _p[61]
...
extern void _cvode_abstol( Symbol**, double*, int);
...
#endif
  hoc_register_prop_size(_mechtype, 73, 5);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 pyrD2pyrD_STFD /home/mizzou/Desktop/ff_BL_addIL/replacehumancell/BMTK/biophys_components/mechanisms/x86_64/pyrD2pyrD_STFD_new.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 167 in file pyrD2pyrD_STFD_new.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/Desktop/ff_BL_addIL/replacehumancell/BMTK/biophys_components/mechanisms/modfiles/pyrD2pyrD_STFD_new.mod";
static const char* nmodl_file_text = 
