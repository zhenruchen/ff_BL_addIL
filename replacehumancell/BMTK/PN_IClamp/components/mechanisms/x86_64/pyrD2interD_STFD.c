...
#define nrn_init _nrn_init__pyrD2interD_STFD
#define _nrn_initial _nrn_initial__pyrD2interD_STFD
#define nrn_cur _nrn_cur__pyrD2interD_STFD
#define _nrn_current _nrn_current__pyrD2interD_STFD
#define nrn_jacob _nrn_jacob__pyrD2interD_STFD
#define nrn_state _nrn_state__pyrD2interD_STFD
#define _net_receive _net_receive__pyrD2interD_STFD 
#define release release__pyrD2interD_STFD 
...
#define eta eta_pyrD2interD_STFD
#define omega omega_pyrD2interD_STFD
#define sfunc sfunc_pyrD2interD_STFD
#define unirand unirand_pyrD2interD_STFD
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 160 in file pyrD2interD_STFD.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
